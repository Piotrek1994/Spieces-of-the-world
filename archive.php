...
echo '<div><h3 class="author-name"><a href="' . esc_url( $author_posts_url ) . '">' . esc_html( $author_name ) . '</a></h3>';
echo '<p class="author-bio">' . esc_html( $author_bio ) . '</p></div>';
echo '<p class="author-social-links">';
echo '<a href="' . esc_url( $linkedin_url ) . '" target="_blank" rel="noopener noreferrer">LinkedIn</a>';
